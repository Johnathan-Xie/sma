...
_import_structure = {
    ...
    "models.sma": ["SMA_PRETRAINED_CONFIG_ARCHIVE_MAP", "SMAConfig", "SMATokenizer"],
...
try:
    ...
    _import_structure["models.sma"].extend(
        [
            "SMAModel",
            "SMALayer",
            "SMAPretrainedModel",
...
if TYPE_CHECKING:
    ...
    from .models.sma import SMA_PRETRAINED_CONFIG_ARCHIVE_MAP, SMAConfig, SMATokenizer
